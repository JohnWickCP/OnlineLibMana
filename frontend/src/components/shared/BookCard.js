...
export default function BookCard({ book }) {
  ...
  return (
    <Link href={`/books/${bookId}`} className="group block">
      <div className="bg-[#E9E7E0] w-[200px] mx-auto">
        ...
        <div className="relative aspect-[2/3] overflow-hidden">
          <img
            src={coverUrl}
            alt={title}
            className="w-full h-full border rounded-lg border-black transition-transform duration-300 "
            onError={(e) => {
              e.target.src =
                "https://via.placeholder.com/300x450/e5e7eb/6b7280?text=No+Cover";
            }}
          ...
          {/* Text Overlay - Ô hình chữ nhật góc dưới luôn hiện */}
