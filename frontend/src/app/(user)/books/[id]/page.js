...
function BookDetailContent() {
    ...
    return (
      <div className="min-h-screen bg-[#E9E7E0] flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-neutral-900 mb-4">Book not found</h2>
  ...
  const authors = book.authors?.map(a => a.author?.key || a.key).join(', ') || 'Unknown Author';
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg mb-4">
                by <span className="text-blue-600 hover:underline cursor-pointer">{authors}</span>
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-6 border-t border-b border-neutral-200">
                <div>
                  ...
                  <p className="font-semibold text-neutral-900">{publishDate}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-neutral-900">
                    <Link href="#" className="text-blue-600 hover:underline">
                      {book.languages?.[0]?.key?.replace('/languages/', '') || 'English'}
                    </Link>
                  </p>
                </div>
                <div>
              ...
              {subjects.length > 0 && (
                <div className="mt-6">
                  <h3 className="text-sm font-semibold text-neutral-700 mb-3">Subjects</h3>
